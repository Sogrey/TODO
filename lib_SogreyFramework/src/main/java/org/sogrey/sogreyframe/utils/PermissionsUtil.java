 ...
 * ********3).如果用户未勾选上面的选项，若选择了Deny，则下次启动Activity会再次弹出系统的Permisssions申请授权对话框。
 ...
 https://github.com/yanzhenjie/AndPermission  pass

https://github.com/lovedise/PermissionGen  ok

https://github.com/googlesamples/easypermissions  ok
 */
            ...
            for (String permission : denidArray) {
                ...
                if (!showRationaleUI(activity, permission)) {
                    ...
                    if (!isAppFirstRun(activity)) {
                        Snackbar snackbar =
                                Snackbar.make(ActivityUtils.getRootView(activity),"这次是真的需要去授权了",
