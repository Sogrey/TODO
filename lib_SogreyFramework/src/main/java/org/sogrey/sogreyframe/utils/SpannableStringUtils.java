 ...
 * <li>setFlag           : 设置标识</li>
 * <li>setForegroundColor: 设置前景色</li>
 * <li>setBackgroundColor: 设置背景色</li>
 * <li>setQuoteColor     : 设置引用线的颜色</li>
 * <li>setLeadingMargin  : 设置缩进</li>
 * <li>setBullet         : 设置列表标记</li>
 * <li>setProportion     : 设置字体比例</li>
 * <li>setXProportion    : 设置字体横向比例</li>
 * <li>setStrikethrough  : 设置删除线</li>
 * <li>setUnderline      : 设置下划线</li>
 * <li>setSuperscript    : 设置上标</li>
 * <li>setSubscript      : 设置下标</li>
 * <li>setBold           : 设置粗体</li>
 * <li>setItalic         : 设置斜体</li>
 * <li>setBoldItalic     : 设置粗斜体</li>
 * <li>setFontFamily     : 设置字体</li>
 * <li>setAlign          : 设置对齐</li>
 * <li>setBitmap         : 设置图片</li>
 * <li>setDrawable       : 设置图片</li>
 * <li>setUri            : 设置图片</li>
 * <li>setResourceId     : 设置图片</li>
 * <li>setClickSpan      : 设置点击事件</li>
 * <li>setUrl            : 设置超链接</li>
 * <li>setBlur           : 设置模糊</li>
 * <li>append            : 追加样式字符串</li>
 * <li>create            : 创建样式字符串</li>
 * </ul>
