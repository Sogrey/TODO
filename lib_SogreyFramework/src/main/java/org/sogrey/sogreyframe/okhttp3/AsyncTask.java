 ...
 *     automatically as of {@link VERSION_CODES#JELLY_BEAN}.</li>
 ...
 * thread. Starting with {@link VERSION_CODES#DONUT}, this was changed
 * to a pool of threads allowing multiple tasks to operate in parallel. Starting with
 * {@link VERSION_CODES#HONEYCOMB}, tasks are executed on a single
...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     * Starting with {@link VERSION_CODES#DONUT}, this was changed
     * to a pool of threads allowing multiple tasks to operate in parallel. Starting
     * {@link VERSION_CODES#HONEYCOMB}, tasks are back to being
