...
class MainActivity: AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spaceNavigationView.addSpaceItem(SpaceItem(getString(R.string.txt_tab_time_management), R.drawable.ic_timer))
        spaceNavigationView.addSpaceItem(SpaceItem(getString(R.string.txt_tab_vid), R.drawable.ic_vid))
        ...
        spaceNavigationView.setSpaceOnLongClickListener(object : SpaceOnLongClickListener {
            override fun onCentreButtonLongClick() {
                Toast.makeText(this@MainActivity, "onCentreButtonLongClick", Toast.LENGTH_SHORT).show()
            }
